...
hicl = hicl.drop(columns=['patientunitstayid','medicationid','drugorderoffset',
                          'drugstartoffset','drugivadmixture',
                          'drugordercancelled','dosage','routeadmin',
                          'frequency','loadingdose','prn','drugstopoffset',
                          'gtc'])
hicl = hicl.dropna()
hicl = hicl.drop_duplicates()
hicl.to_csv("HICLlegend.csv")
