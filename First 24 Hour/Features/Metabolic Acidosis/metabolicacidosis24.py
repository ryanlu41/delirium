...
delirium_ma['metabolicacidosis'] = np.where(delirium_ma['_merge'] == 'left_only', 'na', delirium_ma['metabolicacidosis'])


# Drop unnecessary columns
delirium_ma = delirium_ma[['patientunitstayid', 'metabolicacidosis']]
