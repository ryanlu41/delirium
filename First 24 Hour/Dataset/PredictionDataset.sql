CREATE TABLE "predictdataset" AS
...
AND "nurse"."nursingchartoffset" >= 720)
UNION
SELECT DISTINCT
	"diag"."patientunitstayid"
FROM "eicu_crd"."diagnosis" "diag"
WHERE "diag"."diagnosisstring" = 'neurologic|altered mental status / pain|delirium'
AND "diag"."diagnosisoffset" >= 720
) "del"
...
--Total run time of the whole query: 12 min
--Rows returned of the whole query: 24,695
