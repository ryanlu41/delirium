...
icustays = pd.read_csv(r"C:\Users\Kirby\OneDrive\JHU\SCCM Datathon\mimic-iii-clinical-database-1.4\ICUSTAYS.csv",usecols=['SUBJECT_ID', 'HADM_ID', 'ICUSTAY_ID','INTIME','OUTTIME','LOS'])
